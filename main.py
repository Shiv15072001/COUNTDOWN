...
class MyCountUpApp(App):
    ...
    def build(self):
        ...
        self.Input = TextInput(text="",size_hint=(0.5,0.5),pos_hint={"center_x":0.5,"center_y":0.5})
        ...
        self.label4 = Label(text="", font_size=25,color=(1,0,0,1)) 
    ...
    def Stop_start(self, btn):
        try:
            ...
            self.label4.text = "Invalid Input :- Start"
    ...
    def set(self, btn):
        ...
        try:
            ...
            self.label4.text = "Invalid Input :- Set"
